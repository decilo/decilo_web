...
idleRunner=setTimeout(()=>{M.TapTarget.getInstance($('.tap-target')).open();localStorage.setItem('hasSeenFeatures',!0);if(document.scrollingElement.scrollTop>0){$('html, body')[0].scrollTo({'top':0})}},IDLE_TIMEOUT)}
