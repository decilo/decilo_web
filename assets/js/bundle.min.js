...
function openCommentsModal(message,private){loadRecaptcha();$('#commentsModal').modal('open');let card=$('.message[data-message="'+message+'"]');let image=card.find('img');nsfwMode=(RECIPIENT==null&&typeof(nsfwMode)!='undefined')?nsfwMode:!1;$('#commentsMessageWrapper').html(`<ul class="collection border-dark-8">
