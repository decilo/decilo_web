...
<html lang="es">
    ...
    <body class="bg-light-5 bg-dark-4">
        ...
        <header>
            <nav class="nav-extended bg-light-1 bg-dark-1 <?= isNSFW() ? 'bg-nsfw' : '' ?>">
                <div class="nav-wrapper">
                    <a class="brand-logo thin hand no-select left">
                        ...
                        <?= SYSTEM_TITLE ?>
                        <span class="small nsfw-logo badge red darken-4 light-11 dark-5 hide-on-med-and-down" style="<?= isNSFW() ? 'opacity: 1;' : 'display: none;' ?>"> +18 </span>
                    </a>
                    ...
                    print '
                            ...
                            <div class="switch right">
                                <label class="light-11 dark-5">
                                    <span> NSFW +18 </span>
                                    <input id="nsfwSwitch" type="checkbox" ' . (isNSFW() ? 'checked' : '') . '>
